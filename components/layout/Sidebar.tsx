...
export const Sidebar: React.FC = () => {
  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        { label: 'Booking & Jadwal', path: '/dashboard/bookings', icon: 'fas fa-calendar-alt' },
  ...
  const adminItems = [
    ...
    { label: 'Daftar PayLater', path: '/dashboard/admin/paylater', icon: 'fas fa-clock text-orange-400' }, // NEW
  ];
  ...
  return (
    <aside className="w-64 bg-slate-900 text-white flex flex-col h-screen fixed left-0 top-0 overflow-y-auto z-20 transition-all duration-300">
      {/* Header */}
      <div className="p-6 flex items-center gap-3 border-b border-slate-800 bg-slate-900 sticky top-0 z-10">
